...
export default function Register() {
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      // Ambil user list dari localStorage
      const users = JSON.parse(localStorage.getItem("users") || "[]");
      // Cek userId/email sudah ada
      if (users.find((u) => u.userId === form.userId)) {
        setErrors((e) => ({ ...e, userId: "ID sudah terdaftar" }));
        return;
      }
    ...
    <>
      ...
      <div className="register-bg">
        ...
        <div className="container">
          <h1 className="titleRe">SEAT MASTER</h1>
          {registered && (
